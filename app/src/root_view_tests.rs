...
fn account_first_requires_login_even_without_ai_or_drive_settings() {
    ...
    assert!(requires_post_onboarding_login(false, false, false, true));
    assert!(!requires_post_onboarding_login(true, false, false, true));
    assert!(!requires_post_onboarding_login(false, false, false, false));
}
...
fn fallback_flow_only_requires_login_for_account_backed_settings() {
    ...
    assert!(!requires_post_onboarding_login(false, false, false, true));
    assert!(requires_post_onboarding_login(false, true, false, true));
    assert!(requires_post_onboarding_login(false, false, true, true));
    assert!(!requires_post_onboarding_login(false, true, true, false));
}
